...
class TestBase_from_json_string(unittest.TestCase):
    ...
    def test_from_json_string_one_rectangle(self):
        ...
        self._extracted_from_test_from_json_string_two_squares_3(Rectangle, list_input)
    ...
    def test_from_json_string_one_square(self):
        ...
        self._extracted_from_test_from_json_string_two_squares_3(Square, list_input)
    ...
    # TODO Rename this here and in `test_from_json_string_one_rectangle`, `test_from_json_string_two_rectangles`, `test_from_json_string_one_square` and `test_from_json_string_two_squares`
    def _extracted_from_test_from_json_string_two_squares_3(self, arg0, list_input):
        json_list_input = arg0.to_json_string(list_input)
        list_output = arg0.from_json_string(json_list_input)
