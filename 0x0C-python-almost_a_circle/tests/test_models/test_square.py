...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_size_setter(self):
        s.size = self._extracted_from_test_height_getter_2()

    def test_width_getter(self):
        s.width = self._extracted_from_test_height_getter_2()

    def test_height_getter(self):
        s.height = self._extracted_from_test_height_getter_2()

    # TODO Rename this here and in `test_size_setter`, `test_width_getter` and `test_height_getter`
    def _extracted_from_test_height_getter_2(self):
        s = Square(4, 1, 9, 2)
        s.size = 8
