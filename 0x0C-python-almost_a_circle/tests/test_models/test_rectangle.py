...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_width_setter(self):
        r.width = self._extracted_from_test_y_setter_2()
    ...
    def test_height_setter(self):
        r.height = self._extracted_from_test_y_setter_2()
    ...
    def test_x_setter(self):
        r.x = self._extracted_from_test_y_setter_2()
    ...
    def test_y_setter(self):
        r.y = self._extracted_from_test_y_setter_2()

    # TODO Rename this here and in `test_width_setter`, `test_height_setter`, `test_x_setter` and `test_y_setter`
    def _extracted_from_test_y_setter_2(self):
        r = Rectangle(5, 7, 7, 5, 1)
        result = 10
